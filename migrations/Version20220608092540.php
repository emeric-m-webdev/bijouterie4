...
final class Version20220608092540 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE matiere_produit (matiere_id INT NOT NULL, produit_id INT NOT NULL, INDEX IDX_4A8363DBF347EFB (produit_id), INDEX IDX_4A8363DBF46CD258 (matiere_id), PRIMARY KEY(matiere_id, produit_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
